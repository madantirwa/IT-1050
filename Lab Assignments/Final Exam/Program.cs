...
namespace Final_Exam
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            elevator1IsOverMaxCapacity = elevator1.IsOverMaxCapacity(); //the final value is false
            ...
            elevator2IsOverMaxCapacity = elevator2.IsOverMaxCapacity();  //the final value is true       
        }
    }
}
